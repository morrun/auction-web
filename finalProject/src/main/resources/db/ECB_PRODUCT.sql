...
SET DEFINE OFF;
Insert into ECB_PRODUCT (ID,TITLE,DESCRIPTION,TYPE_ID,PRICE,DEADLINE,PRODUCT_IMAGE_ID) 
values (1,'New iPhoneXS is saling','very new very new very new very new',1,888,TO_DATE('2018/11/25 10:31:22', 'yyyy/mm/dd hh24:mi:ss'),1);
